...
export const card_MeliesU_OnlyTheBrightest: CardDef = {
  ...
  events: [
    ...
    },
    {
      ...
      req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return card.face === 'front'; }),
      msg: 'gain 1 [Credit]', async: true,
      effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreGaining.gainCredits(state, side, eid, 1); })
    },
    {
        ...
        if (context.server && Array.isArray(context.server) && context.server[0] === targetZone && corp?.deck?.length > 0) {
          continue_ability(state, side, {
            optional: {
              ...
              waitingPrompt: true,
              changeInGameState: { silent: true, req: req(function*(state: State): Generator<any, any, any> { return ((state as any).corp?.deck || []).length > 0; }) },
              yesAbility: {
    ...
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
      ...
      continue_ability(state, side, {
        optional: {
          ...
          noAbility: { effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreSay.systemMsg(`declines to use ${card.title} to access 1 additional card`); }) }
        }
      }, card, null);
    })
  }]
    ...
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
      ...
      if (hasIce) {
          ...
          optional: {
            ...
            yesAbility: {
              ...
              effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
                ...
                continue_ability(state, side, coreDefHelpers.offerJackOut({ req: req(function*(state: State): Generator<any, any, any> { return (state as any).run?.['approached-ice?']; }) }), card, null);
              })
            }
          }
        }, card, null);
        ...
        continue_ability(state, 'corp', {
          ...
          effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return coreEid.effectCompleted(eid); })
        }, card, null);
      }
    })
  }]
...
export const card_NathanielGnatHall_OneofaKind: CardDef = {
  ...
  abilities: [{
    ...
    changeInGameState: { silent: true, req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return ((state as any).runner?.hand || []).length < 3; }) },
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreGaining.gainCredits(state, 'runner', eid, 1); }),
    msg: 'gain 1 [Credits]'
  }],
  events: [{ event: 'runner-turn-begins', effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
...
export const card_NBN_ControllingTheMessage: CardDef = {
  ...
  events: [{
    ...
    optional: {
      ...
      yesAbility: {
        trace: { base: 4, successful: { msg: 'give the Runner 1 tag', async: true, effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
          coreTags.gainTags('corp', eid, 1, { unpreventable: true });
        }) } }
      }
    }
  }],
  abilities: [{ effect: effect(function*(state: State): Generator<any, any, any> { coreOptional.setAutoresolve('auto-fire', 'NBN: Controlling the Message'); }) }]
};
...
export const card_NearEarthHub_BroadcastCenter: CardDef = {
  ...
  events: [{
    ...
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreDrawing.draw('corp', eid, 1); })
  }]
};
...
export const card_NebulaTalentManagement_MakingStars: CardDef = {
  ...
  events: [
    ...
    },
    {
      ...
      effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreGaining.gainClicks(state, 'corp', 1); })
    }
  ]
};
  ...
  events: [
    {
      ...
      optional: {
        ...
        yesAbility: {
          ...
          effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { corePlayInstants.playInstant(eid, targets[0]); })
        }
      }
    },
    {
...
export const card_NEXTDesign_GuardingTheNet: CardDef = {
  ...
  abilities: [{
    req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return card['fill-hq']; }),
    label: 'draw remaining cards',
    msg: msg('draw ', (n: number) => utils.quantify(5 - ((state as any).corp?.hand || []).length, 'card')),
    async: true,
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
      yield wait_for(state, [{ asyncResult: 'result' },
        coreDrawing.draw(state, side, 5 - ((state as any).corp?.hand || []).length, { suppressEvent: true })], []);
...
export const card_Noise_HackerExtraordinaire: CardDef = {
  ...
  events: [{
    ...
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreMoving.mill('corp', eid, 'corp', 1); })
  }]
};
...
export const card_Null_Whistleblower: CardDef = {
  ...
  events: [{
    event: 'encounter-ice', skippable: true,
    optional: {
      req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return ((state as any).runner?.hand || []).length > 0; }),
      ...
      yesAbility: {
        ...
        effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
          ...
          coreEffects.registerLingeringEffect(card, {
            ...
            req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return coreCard.sameCard(currentIce, targets[0]); }),
            value: -2
          });
  ...
  events: [
    {
      ...
      effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreGaining.gainCredits('corp', eid, 2); })
    },
    {
      event: 'play-operation-resolved',
      req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
...
export const card_NyushaSableSintashta_SymphonicProdigy: CardDef = {
  ...
  events: [
    ...
    { ...coreMark.identifyMarkAbility, event: 'runner-turn-begins' },
    {
      ...
      msg: 'gain [Click]',
      effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreGaining.gainClicks(1); })
    }
  ]
};
...
export const card_ObSuperheavyLogistics_ExtractExportExcel: CardDef = {
  ...
  flags: { 'corp-phase-12': req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return (card as any).special?.['pause-at-phase-12']; }) },
  events: [{
    event: 'corp-trash',
    req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> {
      const context = (targets as any)[0]?.context || {};
  ...
  events: [
    {
      ...
      changeInGameState: { silent: true, req: req(function*(state: State): Generator<any, any, any> { return ((state as any).corp?.hand || []).length > 0; }) },
      waitingPrompt: true,
    ...
    },
    {
      ...
      optional: {
        ...
        req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return ((state as any).corp?.deck || []).length > 0; }),
        yesAbility: {
...
export const card_PravdivostConsulting_PoliticalSolutions: CardDef = {
  ...
  events: [{
    ...
    req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return coreEvents.firstEvent(state, side, 'successful-run'); }),
    ...
    choices: { req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return coreCard.installed(targets[0]) && coreCard.canBeAdvanced(state, targets[0]); }) },
    ...
    effect: effect(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { coreProps.addProp('corp', eid, targets[0], 'advance-counter', 1, { placed: true }); })
  }]
};
...
export const card_PTUntaian_LifesBuildingBlocks: CardDef = {
  ...
  events: [{
    ...
    req: req(function*(state: State, side: Side, eid: EID, card: Card, targets: any[]): Generator<any, any, any> { return ((state as any).corp?.hand || []).length <= 3; }),
    changeInGameState: { silent: true, req: req(function*(state: State): Generator<any, any, any> {
