  ...
  events: [
    {
      ...
      effect: req(function* (
        ...
        if (top) {
          yield wait_for(
            state,
            [{ asyncResult: "result" }, coreRevealing.reveal(state, side, top)],
            [],
          );
  ...
  abilities: [
    {
      ...
      effect: req(function* (
        ...
        yield wait_for(
          ...
          [
            { asyncResult: "result" },
            coreProps.addProp(state, ":corp", target, ":advance-counter", 1, {
              placed: true,
            }),
          ],
          [],
          ...
          (s: State, _: any, c: Card) => {
            if (
              ...
              coreToasts.toast(
                state,
                ":corp",
                "Cannot score due to PAD Factory.",
                "warning",
              );
              return false;
            }
...
export const palanaAgroplex: CardDef = (() => {
  const ability: any = {
    ...
    effect: req(function* (
      ...
      yield wait_for(
        state,
        [{ asyncResult: "result" }, coreDrawing.draw(state, ":runner", eid, 1)],
        [],
      );
    }),
  };
...
export const personalizedPortal: CardDef = {
  ...
  abilities: [
    coreDefHelpers.setAutoresolve(
      ":auto-fire",
      "Personalized Portal (gain credits)",
    ),
  ],
  events: [
    {
  ...
  const abi: any = coreChooseOne.chooseOneHelper(
    {
      req: req(function* (
        ...
        return (
          (coreEvents.firstEvent(state, ":corp", ":agenda-scored") &&
  ...
  ...advanceAmbush(0, {
    ...
    effect: effect(function* (
      ...
      yield wait_for(
        ...
        [
          { asyncResult: "result" },
          coreAgendas.score(state, side, eid, targets[0], {
            noReq: true,
            ignoreTurn: true,
          }),
        ],
  ...
  const abi: any = {
    ...
    "change-in-game-state": {
      ...
      req: req(function* (
        ...
        return (state as any).corp.discard.some(
          (c: Card) =>
            !(c as any).seen ||
    ...
    effect: req(function* (
      ...
      const t = {
        ...
        special: { rfgWhenTrashed: true },
      };
      yield wait_for(
        state,
        [
          { asyncResult: "result" },
          coreActions.playInstant(
            state,
            side,
            {
              ...eid,
    ...
    events: [
      {
        ...
        effect: req(function* (
          ...
          const currentlyDrawing: Card[] =
            (state as any).corp.currentlyDrawing || [];
          if (currentlyDrawing.some(coreCard.agenda)) {
            const agendas = currentlyDrawing.filter(
              (c: Card) => coreCard.agenda(c) && coreCard.getCard(state, c),
            );
            yield wait_for(
              state,
              [
      ...
      ability: {
        ...
        effect: req(function* (
          ...
          yield wait_for(
            ...
            [
              { asyncResult: "result" },
              coreProps.addCounter(state, side, card, ":power", 1, {
...
export const privateContracts: CardDef = {
  ...
  abilities: [
    coreDefHelpers.takeNCreditsAbility(2, "asset", {
      action: true,
      "keep-menu-open": ":while-clicks-left",
      cost: [corePayment.toC("click", 1)],
    }),
...
export const projectJunebug: CardDef = {
                ...
                "not-equal": {
                  ...
                  effect: effect(function* (
                    ...
                    yield wait_for(
                      ...
                      [
                        { asyncResult: "result" },
                        coreDamage.damage(state, side, eid, ":net", hand, {
                          card,
                        }),
                      ],
                      [],
  ...
  events: [
    ...
    },
    {
      ...
      req: req(function* (
        ...
        const ctx = targets[0];
        return (
          coreCard.sameCard(card, ctx?.card) &&
...
export const quarantineSystem: CardDef = (() => {
    ...
    return {
      ...
      choices: {
        req: req(function* (
          ...
          return (
            coreCard.ice(t) &&
            coreRezzing.canPayToRez(state, side, { ...eid, source: card }, t, {
              costBonus: -discount,
            }) &&
            !coreCard.rezzed(t)
          );
      ...
      effect: req(function* (
        ...
        yield wait_for(
          ...
          [
            { asyncResult: "result" },
            coreRezzing.rez(state, side, targets[0], {
              noWarning: true,
              costBonus: -discount,
            }),
          ],
  ...
  return {
    ...
    abilities: [
      {
        label:
          "Forfeit agenda to rez up to 3 pieces of ice with a 2 [Credit] discount per agenda point",
        req: req(function* (
          state: State,
          side: Side,
          eid: EID,
      ...
      optional: {
        ...
        req: req(function* (
          ...
          const discardTypes = new Set(
            (state as any).corp.discard.map((c: Card) => (c as any).type),
          );
          const drawingTypes = new Set(
            currentlyDrawing.map((c: Card) => (c as any).type),
          );
          const hasIntersection = [...discardTypes].some((t) =>
            drawingTypes.has(t),
          );
          return (
            (state as any).corp.click > 0 &&
            hasIntersection &&
            currentlyDrawing.length > 0
          );
        }),
        "yes-ability": {
          once: ":per-turn",
            ...
            yield wait_for(
              ...
              [
                ...
                coreEngine.resolveAbility(
                  ...
                  {
                    prompt:
                      "Choose a card in HQ that you just drew to swap for a card of the same type in Archives",
                    choices: {
                      card: (c: Card) =>
                        currentlyDrawing.some((d: Card) =>
                          coreCard.sameCard(c, d),
                        ),
                    },
                    async: true,
                    effect: req(function* (
                          ...
                          coreEngine.resolveAbility(
                            ...
                            side,
                            {
                              ...
                              effect: req(function* (
                                ...
                                coreSetAside.swapSetAsideCards(
                                  state,
                                  side,
                                  setAsideCard,
                                  targets[0],
        ...
        [
          ...
          coreEngine.resolveAbility(
            ...
            side,
            {
              optional: {
                prompt:
                  "Trash this asset to gain 3 [Credits] and draw 3 cards?",
                "yes-ability": {
                  async: true,
                  ...
                  effect: req(function* (
                    ...
                    yield wait_for(
                      ...
                      [
                        { asyncResult: "result" },
                        coreMoving.trash(state, side, card, {
                          causeCard: card,
                        }),
                      ],
                      [],
                    ...
                    state.stats[side].rashidaCount =
                      (state.stats[side].rashidaCount || 0) + 1;
                    yield wait_for(
                      state,
                      [
                        { asyncResult: "result" },
                ...
                "yes-ability": {
                  ...
                  effect: req(function* (
                    ...
                    yield wait_for(
                      ...
                      [
                        { asyncResult: "result" },
                        coreDamage.damage(state, side, eid, ":net", 2, {
                          card,
                        }),
                      ],
                      [],
  ...
  events: [
    {
      ...
      effect: effect(function* (
        ...
        yield wait_for(
          ...
          [
            { asyncResult: "result" },
            coreProps.addCounter(state, side, eid, card, ":advancement", 1, {
              placed: true,
            }),
          ],
          [],
...
export const regolithMiningLicense: CardDef = {
  ...
  events: [coreDefHelpers.trashOnEmpty(":credit")],
  abilities: [
    coreDefHelpers.takeNCreditsAbility(3, "asset", {
      action: true,
      "keep-menu-open": ":while-clicks-left",
      cost: [corePayment.toC("click", 1)],
    }),
        ...
        yield wait_for(
          ...
          [
            ...
            coreGaining.loseCredits(
              ...
              ":runner",
              eid,
              4 * coreCard.getCounters(card, ":advancement"),
            ),
          ],
          [],
        );
