// Ported from src/cljc/jinteki/preconstructed.cljc

export type DeckCard = { qty: number; card: string };

export type Identity = { title: string; side: string; code: number };
...
export type Matchup = {
  trInner: string[] | string;
  trTag: string[] | string;
  trDesc: string[] | string;
  trUnderline: string[] | string;
  corp: Deck;
  runner: Deck;
};
...
function precon(name: string, id: Identity, deck: DeckCard[]): Deck {
  return {
    identity: id,
    name: name,
...
const gatewayIntermediateCorp: Deck = {
  format: "system-gateway",
  identity: { title: "The Syndicate: Profit over Principle", side: "Corp", code: 30077 },
  name: "System Gateway Starter Corp",
  cards: [
...
const gatewayIntermediateRunner: Deck = {
  format: "system-gateway",
  identity: { title: "The Catalyst: Convention Breaker", side: "Runner", code: 30076 },
  name: "System Gateway Starter Runner",
  cards: [
...
const systemGatewayBeginner: Matchup = matchup(
  ["lobby.gateway-format.beginner", "Beginner"],
  ["lobby.gateway-format.beginner", "Beginner"],
  ["lobby.gateway-format.beginner-info", "This lobby is using the System Gateway beginner decks for the Corporation and Runner. These decks are recommended for your first games. Games are played to 6 agenda points."],
  ["lobby.gateway-format.beginner-ul", "System Gateway - Beginner Teaching Decks"],
  gatewayBeginnerCorp,
  gatewayBeginnerRunner
);

const systemGatewayIntermediate: Matchup = matchup(
  ["lobby.gateway-format.intermediate", "Intermediate"],
  ["lobby.gateway-format.intermediate", "Intermediate"],
  ["lobby.gateway-format.intermediate-info", "This lobby is using the System Gateway intermediate decks for the Corporation and Runner. These decks have slightly more range than the beginner decks. Games are played to 7 agenda points."],
  ["lobby.gateway-format.intermediate-ul", "System Gateway - Intermediate Teaching Decks"],
  gatewayIntermediateCorp,
  gatewayIntermediateRunner
);

// Worlds 2012: Ben Marsh vs. Jeremy Z
const worlds2012BenCorps: Matchup = matchup(
  ...
  precon("Ben Marsh - 2012: ETF", { title: "Haas-Bioroid: Engineering the Future", side: "Corp", code: 1054 }, [
    { qty: 3, card: "Enigma" },
  ...
  precon("Jeremy Z - 2012: Criminal", { title: "Gabriel Santiago: Consummate Professional", side: "Runner", code: 1017 }, [
    { qty: 2, card: "Corroder" },
    { qty: 1, card: "Yog.0" },
    { qty: 1, card: "Ninja" },
...
const worlds2012BenRuns: Matchup = matchup(
  ...
  precon("Jeremy Z - 2012: Weyland", { title: "Weyland Consortium: Building a Better World", side: "Corp", code: 1093 }, [
    { qty: 3, card: "Priority Requisition" },
    { qty: 3, card: "Private Security Force" },
  ...
  precon("Ben Marsh - 2012: Gabe", { title: "Gabriel Santiago: Consummate Professional", side: "Runner", code: 1017 }, [
...
const worlds2013JensCorps: Matchup = matchup(
  ...
  precon("Jens Erickson - 2013: Engineering the Future", { title: "Haas-Bioroid: Engineering the Future", side: "Corp", code: 1054 }, [
    { qty: 3, card: "Accelerated Beta Test" },
  ...
  precon("Andrew Veen - 2013: Kate McCaffrey", { title: "Kate \"Mac\" McCaffrey: Digital Tinker", side: "Runner", code: 1033 }, [
    { qty: 3, card: "Modded" },
    { qty: 3, card: "Test Run" },
    { qty: 3, card: "Sure Gamble" },
...
const worlds2013JensRuns: Matchup = matchup(
  ...
  precon("Jens Erickson - 2013: Andromeda", { title: "Andromeda: Dispossessed Ristie", side: "Runner", code: 2083 }, [
    { qty: 3, card: "Account Siphon" },
    { qty: 3, card: "Inside Job" },
    { qty: 3, card: "Special Order" },
...
const worlds2014DanDCorps: Matchup = matchup(
  ...
  precon("Dan D'Argenio - 2014: Honor and Perfection", { title: "Jinteki: Replicating Perfection", side: "Corp", code: 2031 }, [
  ...
  precon("Minh Tran - 2014: Andromedium", { title: "Andromeda: Dispossessed Ristie", side: "Runner", code: 2083 }, [
    { qty: 3, card: "Account Siphon" },
...
const worlds2014DanDRuns: Matchup = matchup(
  ...
  precon("Minh Tran - 2014: Personal Evolution", { title: "Jinteki: Personal Evolution", side: "Corp", code: 1067 }, [
    { qty: 3, card: "Fetal AI" },
  ...
  precon("Dan D'Argenio - 2014: Daily QT Andy", { title: "Andromeda: Dispossessed Ristie", side: "Runner", code: 2083 }, [
    { qty: 3, card: "Account Siphon" },
...
const worlds2015DanDCorps: Matchup = matchup(
  ...
  precon("Dan D'Argenio - 2015: Foodcoatshop", { title: "Haas-Bioroid: Engineering the Future", side: "Corp", code: 1054 }, [
    { qty: 3, card: "Accelerated Beta Test" },
  ...
  precon("Timmy Wong - 2015: The Morning After", { title: "Whizzard: Master Gamer", side: "Runner", code: 2001 }, [
    { qty: 2, card: "Stimhack" },
    { qty: 3, card: "Sure Gamble" },
    { qty: 1, card: "Test Run" },
    { qty: 3, card: "Inject" },
...
const worlds2015DanDRuns: Matchup = matchup(
  ...
  precon("Timmy Wong - 2015: Yellow Shell", { title: "Near-Earth Hub: Broadcast Center", side: "Corp", code: 6005 }, [
    { qty: 3, card: "AstroScript Pilot Program" },
    { qty: 3, card: "Breaking News" },
  ...
  precon("Dan D'Argenio - 2015: Radisson Cheese Plate", { title: "Valencia Estevez: The Angel of Cayambe", side: "Runner", code: 7030 }, [
...
const worlds2016ChrisDyerCorps: Matchup = matchup(
  ...
  precon("Chris Dyer - 2016: Snekbite", { title: "NBN: Controlling the Message", side: "Corp", code: 11017 }, [
  ...
  precon("Benjamin Ni - 2016: Minh MaxX++", { title: "MaxX: Maximum Punk Rock", side: "Runner", code: 7029 }, [
    { qty: 3, card: "Déjà Vu" },
    { qty: 2, card: "Account Siphon" },
    { qty: 3, card: "Sure Gamble" },
...
const worlds2016ChrisDyerRuns: Matchup = matchup(
  ...
  precon("Benjamin Ni - 2016: Fiery Info", { title: "SYNC: Everything, Everywhere", side: "Corp", code: 9001 }, [
    { qty: 3, card: "Breaking News" },
  ...
  precon("Chris Dyer - 2016: Papa Smurf", { title: "Whizzard: Master Gamer", side: "Runner", code: 2001 }, [
    { qty: 1, card: "Déjà Vu" },
    { qty: 3, card: "Sure Gamble" },
    { qty: 3, card: "Dirty Laundry" },
    { qty: 1, card: "Retrieval Run" },
...
const worlds2017JessCorps: Matchup = matchup(
  ...
  precon("ChaosJuggler - 2017: Sinson Reversed CI", { title: "Cerebral Imaging: Infinite Frontiers", side: "Corp", code: 3001 }, [
  ...
  precon("Grey Tongue - 2017: Aesops Hayley", { title: "Hayley Kaplan: Universal Scholar", side: "Runner", code: 8025 }, [
    { qty: 2, card: "Stimhack" },
    { qty: 3, card: "Sure Gamble" },
...
const worlds2017JessRuns: Matchup = matchup(
  ...
  precon("Grey Tongue - 2017: No-Show Rewiring CI", { title: "Cerebral Imaging: Infinite Frontiers", side: "Corp", code: 3001 }, [
  ...
  precon("ChaosJuggler - 2017: Laguna Lock Hayley", { title: "Hayley Kaplan: Universal Scholar", side: "Runner", code: 8025 }, [
    { qty: 3, card: "Indexing" },
...
const worlds2018JoeCorps: Matchup = matchup(
  ...
  precon("Joe Schupp - 2018: AMERICA CtM", { title: "NBN: Controlling the Message", side: "Corp", code: 11017 }, [
    { qty: 1, card: "15 Minutes" },
  ...
  precon("Chris Dyer - 2018: Gooseberry MaxX", { title: "MaxX: Maximum Punk Rock", side: "Runner", code: 7029 }, [
    { qty: 3, card: "Dirty Laundry" },
