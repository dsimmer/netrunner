...
import {
  handshakeHandler as wsHandshakeHandler,
  postHandler as wsPostHandler,
} from "./ws";
import {
  cardsHandler,
  cardsVersionHandler,
...
import {
  configHandler as chatConfigHandler,
  messagesHandler as chatMessagesHandler,
} from "./chat";
import {
  decksHandler,
  decksCreateHandler,
  decksSaveHandler,
  decksDeleteHandler,
  decksBulkDeleteHandler,
} from "./decks";
import {
  apiKeysHandler,
  apiKeysCreateHandler,
...
import {
  ...
  wrapAuthorizationRequired,
  wrapTournamentAuthRequired,
  wrapUser,
} from "./auth";
import {
  newsCreateHandler,
...
export type Handler = (
  ...
  | ApiResponse
  | void
  | Promise<HttpResponse | ApiResponse | void>;
  ...
  return (req, res) => {
    if (req.method === "GET" && req.url === "/favicon.ico") {
      const faviconPath = path.resolve(
        __dirname,
        "../../../resources/public/img/jinteki.ico",
      );
  ...
  if (routePath === "" || routePath === "/") {
    if (urlPath === "/" || urlPath === "") {
      if (route.methods && route.methods[method.toLowerCase()]) {
        return {
          handler: route.methods[method.toLowerCase()],
          pathParams: {},
...
function apiRoutes(): RouteDefinition[] {
  return [
    // WebSocket
    {
      path: "/chsk",
      methods: {
        get: (r, res) => wsHandshakeHandler(r, res),
        post: (r, res) => wsPostHandler(r, res),
      },
      middleware: ["forgery"],
    },
    // Data
    {
      ...
      children: [
          ...
          children: [
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = cardsHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = cardsVersionHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = altArtsHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = cardLangHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
        ...
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = newsHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = setsHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = mwlHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = cyclesHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = donorsHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
          ...
          children: [
            {
              ...
              methods: {
                get: (r, res) => {
                  const db = r.system?.db;
                  const user = r.user || {};
                  const result = decksHandler(db as any, user);
                  writeResponse(res, result);
                  return result;
                },
                post: (r, res) => {
                  const db = r.system?.db;
                  const user = r.user || {};
                  const result = decksCreateHandler(
                    db as any,
                    user,
                    r.body as any,
                  );
            ...
            },
            {
              ...
              methods: {
                delete: (r, res) => {
                  const db = r.system?.db;
                  const user = r.user || {};
                  const id = r["path-params"]?.id;
                  const result = decksDeleteHandler(db as any, user, id || "");
                  writeResponse(res, result);
                  return result;
                },
              },
        ...
        {
          path: "/decks-bulk-delete",
          methods: {
            post: (r, res) => {
              const db = r.system?.db;
              const user = r.user || {};
              const result = decksBulkDeleteHandler(
                db as any,
                user,
                r.body as any,
              );
          ...
          children: [
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = apiKeysHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
                post: (r, res) => {
                  const result = apiKeysCreateHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                delete: (r, res) => {
                  const result = apiKeysDeleteHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
        ...
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = langHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
    ...
    // Chat config
    {
      ...
      methods: {
        get: (r, res) => {
          const result = chatConfigHandler(r as any, res);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Chat messages
    {
      ...
      methods: {
        get: (r, res) => {
          const result = chatMessagesHandler(r as any, res);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Password reset
    {
      ...
      methods: {
        get: (r, res) => {
          const result = resetPasswordPage(r as any, res);
          return result;
        },
        post: (r, res) => {
          const result = resetPasswordHandler(r as any);
          if (result) writeResponse(res, result);
          return result;
        },
      },
    },
    // Replay viewer
    {
      ...
      methods: {
        get: (r, res) => {
          const result = replayHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Bug report viewer
    {
      path: "/bug-report/:bugid",
      methods: {
        get: (r, res) => {
          (r as any)["path-params"] = {
            ...(r as any)["path-params"],
            gameid: (r as any)["path-params"]?.bugid,
          };
          const result = replayHandler(r as any);
          writeResponse(res, result);
          return result;
    ...
    // Register
    {
      ...
      methods: {
        post: (r, res) => {
          const result = authRegisterHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Check username
    {
      ...
      methods: {
        get: (r, res) => {
          const result = checkUsernameHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Check email
    {
      ...
      methods: {
        get: (r, res) => {
          const result = checkEmailHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Login
    {
      ...
      methods: {
        post: (r, res) => {
          const result = authLoginHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Forgot password
    {
      ...
      methods: {
        post: (r, res) => {
          const result = forgotPasswordHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Logout
    {
      ...
      methods: {
        post: (r, res) => {
          const result = authLogoutHandler(r as any);
          writeResponse(res, result);
          return result;
        },
      },
      middleware: ["auth", "forgery"],
    },
    // Game API
    {
      path: "/game",
      middleware: ["forgery", "cors", "cache-headers"],
      children: [
        {
          path: "/decklist",
          methods: {
            get: (r, res) => {
              const result = decklistHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = handHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = discardHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = deckHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = logHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
      ...
      children: [
        {
          ...
          methods: {
            put: (r, res) => {
              const result = updateProfileHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: (r, res) => {
              const result = emailHandler(r as any);
              writeResponse(res, result);
              return result;
            },
            put: (r, res) => {
              const result = changeEmailHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
          ...
          children: [
            {
              ...
              methods: {
                delete: (r, res) => {
                  const result = clearUserstatsHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                delete: (r, res) => {
                  const result = clearDeckstatsHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
          ...
          children: [
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = historyHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = fetchLog(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
              ...
              children: [
                {
                  ...
                  methods: {
                    get: (r, res) => {
                      const result = fetchAnnotations(r as any);
                      writeResponse(res, result);
                      return result;
                    },
                  },
                },
                {
                  ...
                  methods: {
                    get: (r, res) => {
                      const result = publishAnnotations(r as any);
                      writeResponse(res, result);
                      return result;
                    },
                  },
                },
                {
                  ...
                  methods: {
                    delete: (r, res) => {
                      const result = deleteAnnotations(r as any);
                      writeResponse(res, result);
                      return result;
                    },
                  },
            ...
            },
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = shareReplay(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                get: (r, res) => {
                  const result = fetchReplay(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
    ...
    // Tournament auth
    {
      path: "/tournament-auth/:username",
      methods: {
        get: (r, res) => {
          const result = tournamentAuth(r);
          writeResponse(res, result);
          return result;
        },
      },
      middleware: ["auth", "tournament-auth", "forgery"],
    },
    // Prizes auth
    {
      path: "/prizes/:username",
      methods: {
        get: (r, res) => {
          const result = prizesAuth(r);
          writeResponse(res, result);
          return result;
        },
      },
    ...
    // Admin
    {
      ...
      children: [
          ...
          children: [
            {
              ...
              methods: {
                post: async (r, res) => {
                  const result = await newsCreateHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
            },
            {
              ...
              methods: {
                delete: async (r, res) => {
                  const result = await newsDeleteHandler(r as any);
                  writeResponse(res, result);
                  return result;
                },
              },
        ...
        },
        {
          ...
          methods: {
            get: async (r, res) => {
              const result = await versionHandler(r as any);
              writeResponse(res, result);
              return result;
            },
            put: async (r, res) => {
              const result = await versionUpdateHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
        },
        {
          ...
          methods: {
            get: async (r, res) => {
              const result = await bannedMessageHandler(r as any);
              writeResponse(res, result);
              return result;
            },
            put: async (r, res) => {
              const result = await bannedMessageUpdateHandler(r as any);
              writeResponse(res, result);
              return result;
            },
          },
...
function applyMiddleware(
  ...
  for (const name of reversed) {
    switch (name) {
      case "forgery":
        current = wrapAntiForgery(current);
        break;
      case "cors":
        current = wrapCors(
          () => true,
        ...
        break;
      case "cache-headers":
        current = wrapAddCacheHeaders(current);
        break;
      case "json-body":
        current = wrapJsonBody(current);
        break;
      case "cookies":
        current = wrapCookies(current);
        break;
      case "url-parser":
...
function createRequestHandler(
  routes: RouteDefinition[],
  system?: System,
): (req: ApiRequest, res: ServerResponse) => void {
...
export function makeApp(
  ...
  const wrappedHandler = applyMiddleware(
    requestHandler,
    ["url-parser", "json-body", "cookies", "system", "user"],
    system,
  );
...
export function makeDevApp(
  ...
  const wrappedHandler = applyMiddleware(
    requestHandler,
    ["stacktrace", "url-parser", "json-body", "cookies", "system", "user"],
    system,
  );
  return wrappedHandler as (req: ApiRequest, res: ServerResponse) => void;
}
